                ...
                <table class="table table-bordered table-hover table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>  <a style="height:30px; width:50px; background-color:blue; border-color: blue;" class="btn btn-danger btn-sm" href="{{ route('product.edit',$product->id) }}">Edit</a></td>
                            <td>
                                <form id="delete-form-{{ $product->id }}" action="{{ route('product.delete',$product->id) }}" style="display: none;" method="POST">
                                    @csrf
                                    @method('DELETE')
                                </form>
                                <button type="button" class="btn btn-danger btn-sm" onclick="if(confirm('Are you sure? You want to delete this produc?')){

...
<body>
    ...
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="{{ route('home') }}"><i class="fa fa-home fa-fw"></i> Homepage</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="{{ route('gallery.create') }}"><i class="fa fa-camera-retro fa-fw"></i> Gallery</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Change Background Picture</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
